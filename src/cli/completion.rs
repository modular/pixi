...
;;
  ...
  export extern "pixi run" [
    ...
    --pypi-keyring-provider: string@"pixi run pypi_keyring_provider" # Specifies if we want to use uv keyring provider
    --clean-env               # Use a clean environment to run the task
    --verbose(-v)             # Increase logging verbosity
    --quiet(-q)               # Decrease logging verbosity
    --color: string@"pixi run color" # Whether the log needs to be colored
